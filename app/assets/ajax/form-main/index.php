...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	if (empty($data->potential_customer->name))
		$errors["phone"] = true;
	...
	$to = "terechov.m.g@gmail.com";
	$subject = $_SERVER["HTTP_HOST"] . " :: Сообщение из формы \"Оставить заявку (первый экран)\"";		
	$body = "
			Информационное сообщение сайта " . $_SERVER["HTTP_HOST"] . "
			------------------------------------------------------------

			Вам было отправлено сообщение через форму \"Оставить заявку (первый экран)\"
